...
const imagesSlider1 = [
  "/images/nature/swamp.png",
  "/images/nature/forest.png",
  "/images/nature/sea.png",
];

const imagesSlider2 = [
  "/images/people/woman5.png",
  "/images/nature/forest.png",
  "/images/nature/sea.png",
];

const imagesSlider3 = [
  "/images/people/family6.png",
  "/images/nature/forest.png",
  "/images/nature/sea.png",
];
                ...
                <div className="hidden space-y-3 md:block lg:space-y-6">
                  ...
                  <div className="flex items-center gap-6">
                    ...
                    <div className="w-96 bg-white h-1 rounded-full">
                      <div className="h-full bg-orange-borneo rounded-full" style={{ width: `${Math.ceil((index + 1) * 33.3)}%` }}></div>
                    </div>
                    <p>{">>"}</p>
                  </div>
                </div>
