	...
	return (
		<header className={cx("w-full relative", "h-screen", "fullscreen")}>
			...
			<div className="absolute z-20 text-white flex flex-col gap-6 items-center justify-center h-full w-full px-4 sm:px-12 md:px-16 md:gap-10">
				<h1 className={cx("text-sm text-center font-semibold md:text-base uppercase lg:text-lg tracking-widest")}>Borneo river cruise</h1>
				<h2 className={cx("text-title leading-tight font-prata text-center xl:w-[60%]")}>Discover Borneo's Hidden Heart</h2>
