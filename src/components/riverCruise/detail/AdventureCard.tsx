...
const AdventureCard = ({ data }: { data: { img: string, title: string, desc: string } }) => {
    return (
        <div className="relative w-full rounded-xl overflow-hidden bg-white shadow-lg">
            <div className="absolute inset-0 bg-black/40 z-10"></div>
            <Image src={data.img} alt="picture of orang utan" className="w-full object-cover h-full aspect-square" height={1000} width={1000} />
