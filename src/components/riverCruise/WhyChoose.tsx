	...
	return (
		<section id="whyChooses">
			<div className={cx("w-full h-full relative px-4 space-y-4 sm:space-y-0 sm:px-0")}>
				<div className={cx("z-20 flex text-center sm:absolute sm:items-center sm:justify-center sm:text-white sm:h-full sm:w-full")}>
					<p className={cx("font-prata text-subtitle text-center")}>Why Choose Wow Borneo?</p>
				</div>
			...
			<Container className="grid grid-cols-1 gap-8 xl:grid-cols-2">
				...
				<div className="w-full h-full grid grid-cols-1 gap-6 sm:grid-cols-2 xl:order-first">
					<div className={cx("w-full aspect-[9/12]")}>
						<GradientImage className="rounded-[16px]" src="/images/people/man.png" />
					</div>
					<div className={cx("w-full aspect-[9/12] xl:mt-20")}>
						<GradientImage className="rounded-[16px]" src="/images/wildlife/orangutan4.png" />
					</div>
				</div>
			</Container>
		</section>
