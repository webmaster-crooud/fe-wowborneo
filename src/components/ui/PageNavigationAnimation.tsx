...
const heroImages: { [key: string]: string } = {
    "/": "/images/boats/exterior/boat3.png",
...
const PageNavigationAnimation = () => {
    ...
    return (
        <>
            <div
                className={cx(
                    "fixed z-50 top-0 w-full h-screen bg-white max-h-screen initial-banner")}
            >
            ...
            <div
                className={cx(
                    "fixed z-40 top-0 w-full h-screen bg-white max-h-screen page-banner hidden")}
            />
        </>
    )
}
